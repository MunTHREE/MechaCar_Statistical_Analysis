...
mecha_data <- read.csv("/Users/mitchellmundie/msu/Module_15/MechaCar_Statistical_Analysis/Resources/MechaCar_mpg.csv",stringsAsFactors = F,check.names = F)
...
# Read in the csv file
suspension_data <- read.csv("/Users/mitchellmundie/msu/Module_15/MechaCar_Statistical_Analysis/Resources/Suspension_Coil.csv",stringsAsFactors = F, check.names = F)
